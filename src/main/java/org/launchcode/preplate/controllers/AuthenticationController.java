...
import org.launchcode.preplate.models.dto.LoginFormDTO;
import org.launchcode.preplate.models.dto.RegisterFormDTO;
...
public class AuthenticationController {
    ...
    public String processRegistrationForm(@ModelAttribute @Valid RegisterFormDTO registerFormDTO,
        ...
        if (existingUser != null) {
            errors.rejectValue("email", "username.alreadyexists", "A user with that email already exists");
            model.addAttribute("title", "Register");
            return "register";
        }
